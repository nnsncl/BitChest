...
export default function Navigation() {
    return (
        <nav className='rounded-xl text-white bg-gray-800 flex items-center justify-between w-full md:w-32 md:flex-col flex-row md:py-12 py-3 md:px-3 px-6' >
            <span className='text-sm md:block hidden'>Bit<b>Chest</b></span>
            <ul className='flex md:h-full md:flex-col flex-row md:gap-0 gap-3'>
                <li className='md:mt-16 mt-0 text-center' >
                    <Button>
                ...
                <li className='md:mt-8 mt-0 text-center' >
                    <Button>
